...
CppWorkflowResult __RDF_WORKFLOW_FUNCTION__0(ROOT::RDF::RNode &rdf0)
{
  ...
  auto rdf1 = rdf0.Define("weight", "scaleFactor_PHOTON * scaleFactor_PhotonTRIGGER * scaleFactor_PILEUP * mcWeight");
  ...
  auto res_ptr0 = rdf10.Histo1D({"ggH","Diphoton invariant mass; m_{#gamma#gamma} [GeV];Events",30,105,160}, "m_yy", "weight");
