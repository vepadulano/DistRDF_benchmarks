...
void run() {
    ...
    ROOT::RDataFrame df_data("mini", gamgam_files);
    ROOT::RDataFrame df_ggH("mini", path + "/mc_343981.ggH125_gamgam.GamGam.root");
    ROOT::RDataFrame df_VBF("mini", path + "/mc_345041.VBFH125_gamgam.GamGam.root");
