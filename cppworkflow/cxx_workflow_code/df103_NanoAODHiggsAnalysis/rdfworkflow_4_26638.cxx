...
CppWorkflowResult __RDF_WORKFLOW_FUNCTION__4(ROOT::RDF::RNode &rdf0)
{
  ...
  auto rdf14 = rdf13.Define("weight", "1.0");
  auto res_ptr0 = rdf14.Histo1D({"h_data_4el","",36,70,180}, "H_mass", "weight");
