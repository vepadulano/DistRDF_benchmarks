...
for dataset in datasets:
    for df,times_dict in (df104_opt_pydistrdf,df104_times_pydistrdf), (df104_opt_cxxdistrdf,df104_times_cxxdistrdf):
...
for times_dict in df104_times_pydistrdf, df104_times_cxxdistrdf:
    for dataset in datasets:
...
for time_type, color in zip(time_types,colors):
    ...
    for dataset in datasets:
        t.append(0)
        t.append(df104_times_pydistrdf[dataset][time_type])
