...
TIMES_DIR=time_results/10xdata/patch_lambdas
NTESTS=5
BENCHMARK_DIR=benchmarks

mkdir -p $TIMES_DIR

for benchmark_name in df102_NanoAODDimuonAnalysis_lambdas_10xdata df103_NanoAODHiggsAnalysis_lambdas_10xdata df104_HiggsToTwoPhotons_lambdas_10xdata
do
